                  ...
                  tabPanel(
                    ...
                    div(
                      wellPanel(
                        ...
                        tags$img(src = "instruction_flow_chart.png", height = "400px", width = "auto"),br(),
                        p(),
                        HTML("Some Tips:<br>
                         ...
                         wellPanel(
                           ...
                           fluidRow(
                             column(
                               ...
                               tags$img(src = "between_model_selection_fp1.png", height = "400px", width = "auto"),br(),
                               
                             ),
                             column(
                               width =6,
                               HTML("<b>Survival plot of FP1, power = 3, example data of ALK-NSCLC network</b>"),
                               tags$img(src = "between_model_selection_fp2.png", height = "400px", width = "auto"),br(),
                             )
                           ),
                           p(),
                           ...
                           fluidRow(
                             column(
                               ...
                               tags$img(src = "between_model_selection_psm.png", height = "400px", width = "auto"),br(),
                             )
                           ),
                           p(),
